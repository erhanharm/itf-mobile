...
//	int save_pos;
//	
//	public ReplyAdapter(Activity context, int resource, int textViewResourceId, List<Reply> objects, int type) {
...
//
//		final Reply a = lst.get(position);
//
...
//				}
//				else {
//					save_ans=(Reply)v.getTag(R.string.TAG_ANSWER);
