...
public class QuestionAdapter extends ArrayAdapter<Question> {
	...
	public QuestionAdapter(Activity context, int resource, int textViewResourceId, List<Question> objects, int type) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(q.getIsAnswered()==1)
			...
			holder.btnAnswer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(!Utils.isLogin){
						...
						intent.putExtra("question", (Question)v.getTag());
			...
			holder.btnSolved.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					save_q=(Question)v.getTag(R.string.TAG_QUESTION);
